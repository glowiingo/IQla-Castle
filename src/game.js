...
const config = {
  ...
  scene: [preload_scene, gameplay_scene,
    mapOverlay_scene, minigame_scene_manager, mouse_click_minigame, book_click_minigame,
    playerUI_scene, title_screen_scene, join_game_scene,
    voting_scene, showPositionPlayer_scene, chat_scene, trap_making_minigame, temp_game_end_scene, player_death_scene, endGame_scene]
