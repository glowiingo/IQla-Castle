...
class kill_scene extends Phaser.Scene {
  ...
  create() {
    ...
    this.player = this.physics.add
      .sprite(game.config.width / 4, game.config.height / 4, "haachama")
      .setScale(0.5);
    this.player.setCollideWorldBounds(true);

    this.player2 = this.physics.add
      .sprite(game.config.width / 2, game.config.height / 2, "haachama")
      .setScale(0.5);
    this.player2.setCollideWorldBounds(true);

    this.player3 = this.physics.add
      .sprite(game.config.width / 3, game.config.height / 3, "haachama")
      .setScale(0.5);
    this.player3.setCollideWorldBounds(true);

    this.player4 = this.physics.add
      .sprite(game.config.width / 6, game.config.height / 6, "haachama")
      .setScale(0.5);
